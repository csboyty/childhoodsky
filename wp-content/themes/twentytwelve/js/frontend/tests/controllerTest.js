...
(function(){
    ...
    test("doResponse",function(){
        ...
        function testEveryCategory(args){
            ...
            if(type=="people"){
                list.attr("id","zy_section_two_list");
            }else if(type=="landscape"){
                list.attr("id","zy_section_one_list");
            }else if(type=="artifact"){
                list.attr("id","zy_section_three_list");
            }else if(type=="community"){
                list.attr("id","zy_section_four_list");
            }
            ...
            if(type=="people"){
                equal(list.find("li.zy_section_two_article").length,3,type+" right count li");
            }else if(type=="landscape"){
                equal(list.find("li.zy_section_one_article").length,2,type+" right count li");
            }else if(type=="artifact"){
                equal(list.find("li.zy_section_three_article").length,2,type+" right count li");
            }else if(type=="community"){
                equal(list.find("li.zy_section_four_article").length,3,type+" right count li");
            }
