...
class zy_ajax_class{
    ...
    public function zy_get_top_posts(){
        ...
        $results=$wpdb->get_results("SELECT * FROM $view  WHERE post_id in (SELECT post_id FROM $view
        WHERE term_id=".self::ZY_TOP_TERM_ID.") LIMIT ".self::ZY_TOP_POST_COUNT);
