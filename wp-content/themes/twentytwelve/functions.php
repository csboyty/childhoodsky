...
function zy_load_resource($hook){
    ...
    if(($_GET["post_type"]=="zy_music"&&$hook=="post-new.php")||($hook=="post.php"&&get_post($_GET["post"])->post_type=="zy_music")){
        ...
        //加载音乐js
        wp_enqueue_script("zy_music_js",$zy_template_url.'/js/backend/src/zy_music.js');
        //引入自定义的css
        wp_enqueue_style("zy_music_css",$zy_template_url.'/css/backend/src/zy_music.css');
        ...
        wp_enqueue_script("zy_common_js",$zy_template_url.'/js/backend/src/zy_common.js');
        //引入文章页面的js
        wp_enqueue_script("zy_post_js",$zy_template_url.'/js/backend/src/zy_post.js');
        //引入自定义的css
        wp_enqueue_style("zy_post_css",$zy_template_url.'/css/backend/src/zy_post.css');
        ...
        //引入文章页面的js
        wp_enqueue_script("zy_slide_js",$zy_template_url.'/js/backend/src/zy_slide.js');
        //引入自定义的css
        wp_enqueue_style("zy_slide_css",$zy_template_url.'/css/backend/src/zy_slide.css');
